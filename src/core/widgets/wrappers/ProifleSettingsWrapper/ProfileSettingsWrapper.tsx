import { SCREEN_PADDING_HORIZONTAL } from '@core/config/const';
			...
			<ScrollOrEmpty>
				<View
					style={[
						s.wrapper,
						{
							marginTop: needHeader && !noSafeZone ? safeZoneHeight : 0,
						},
						wrapperStyle
					]}
				>
			...
			<ScrollOrEmpty>
				<View
					style={[
						s.wrapper,
						{
							marginTop: needHeader && !noSafeZone ? safeZoneHeight : (onlyLayout ? safeAreaWithContentHeight : 0),
